...
},{"rx":26}],2:[function(require,module,exports){
"use strict";
 ...
 */
},{"./mock-dom-source":4,"./render-dom":5,"./render-html":6,"./virtual-hyperscript":8,"hyperscript-helpers":18,"virtual-dom/virtual-hyperscript/svg":53}],3:[function(require,module,exports){
"use strict";
...
},{"rx":26}],5:[function(require,module,exports){
"use strict";
...
},{"./fromevent":3,"./transposition":7,"./virtual-hyperscript":8,"matches-selector":23,"rx":26,"vdom-parser":32,"virtual-dom/diff":39,"virtual-dom/patch":40}],6:[function(require,module,exports){
"use strict";
...
},{"./transposition":7,"rx":26,"vdom-to-html":36}],7:[function(require,module,exports){
"use strict";
...
},{"rx":26,"virtual-dom/vnode/vnode":61}],8:[function(require,module,exports){
/* eslint-disable */
'use strict';
...
/* eslint-enable */
},{"virtual-dom/virtual-hyperscript/hooks/ev-hook.js":48,"virtual-dom/virtual-hyperscript/hooks/soft-set-hook.js":49,"virtual-dom/virtual-hyperscript/parse-tag.js":51,"virtual-dom/vnode/is-thunk":55,"virtual-dom/vnode/is-vhook":56,"virtual-dom/vnode/is-vnode":57,"virtual-dom/vnode/is-vtext":58,"virtual-dom/vnode/is-widget":59,"virtual-dom/vnode/vnode.js":61,"virtual-dom/vnode/vtext.js":63,"x-is-array":66}],9:[function(require,module,exports){
"use strict";
...
},{"rx":26,"superagent":31}],10:[function(require,module,exports){
"use strict";
...
},{"./http-driver":9}],11:[function(require,module,exports){
...
},{"emitter":14,"reduce":25}],32:[function(require,module,exports){
...
},{"./namespace-map":33,"./property-map":34,"virtual-dom/vnode/vnode":61,"virtual-dom/vnode/vtext":63}],33:[function(require,module,exports){
...
},{"./property-config":37,"escape-html":15}],36:[function(require,module,exports){
var escape = require('escape-html');
...
},{"./create-attribute":35,"./void-elements":38,"escape-html":15,"param-case":24,"virtual-dom/virtual-hyperscript/hooks/attribute-hook":47,"virtual-dom/virtual-hyperscript/hooks/soft-set-hook":49,"virtual-dom/vnode/is-thunk":55,"virtual-dom/vnode/is-vnode":57,"virtual-dom/vnode/is-vtext":58,"virtual-dom/vnode/is-widget":59,"xtend":67}],37:[function(require,module,exports){
/**
 * Attribute types.
 */
...
},{"./vtree/diff.js":65}],40:[function(require,module,exports){
...
},{"../vnode/is-vhook.js":56,"is-object":21}],42:[function(require,module,exports){
...
},{"../vnode/handle-thunk.js":54,"../vnode/is-vnode.js":57,"../vnode/is-vtext.js":58,"../vnode/is-widget.js":59,"./apply-properties":41,"global/document":17}],43:[function(require,module,exports){
...
},{"../vnode/is-widget.js":59,"../vnode/vpatch.js":62,"./apply-properties":41,"./update-widget":46}],45:[function(require,module,exports){
var document = require("global/document")
var isArray = require("x-is-array")
...
},{"./create-element":42,"./dom-index":43,"./patch-op":44,"global/document":17,"x-is-array":66}],46:[function(require,module,exports){
var isWidget = require("../vnode/is-widget.js")
...
},{"../vnode/is-widget.js":59}],47:[function(require,module,exports){
'use strict';
...
},{"ev-store":16}],49:[function(require,module,exports){
'use strict';
...
},{"../vnode/is-thunk":55,"../vnode/is-vhook":56,"../vnode/is-vnode":57,"../vnode/is-vtext":58,"../vnode/is-widget":59,"../vnode/vnode.js":61,"../vnode/vtext.js":63,"./hooks/ev-hook.js":48,"./hooks/soft-set-hook.js":49,"./parse-tag.js":51,"x-is-array":66}],51:[function(require,module,exports){
'use strict';
...
},{"./hooks/attribute-hook":47,"./index.js":50,"./svg-attribute-namespace":52,"x-is-array":66}],54:[function(require,module,exports){
...
function main(sources) {
  ...
  var getAllUsers$ = sources.DOM.select('.get-all').events('click').map(function () {
    return {
      url: USERS_URL,
      method: 'GET'
    };
  ...
  var users$ = sources.HTTP.filter(function (res$) {
    return res$.request.url.indexOf(USERS_URL) === 0;
  }).mergeAll().map(function (res) {
    return res.body;
  }).startWith([]);

  var inputEvent$ = sources.DOM.select('.field').events('input');
  var search$ = inputEvent$.map(function (ev) {
    return ev.target.value;
  }).startWith('');

  var vtree$ = users$.map(function (users) {
    return (0, _cycleDom.div)('.users', [(0, _cycleDom.label)('Search user name: '), (0, _cycleDom.input)('.field', { type: 'text' }), (0, _cycleDom.button)('.search', 'Search'), (0, _cycleDom.button)('.get-all', 'Get all users'), (0, _cycleDom.hr)()].concat(_toConsumableArray(users.map(function (user) {
      return (0, _cycleDom.div)('.user-details', [(0, _cycleDom.h4)('.user-name', user.name), (0, _cycleDom.h4)('.user-username', user.username), (0, _cycleDom.h4)('.user-email', user.email), (0, _cycleDom.a)('.user-website', { href: user.website }, user.website)]);
    }))));
  });
...
var drivers = {
  DOM: (0, _cycleDom.makeDOMDriver)('#app-main'),
  HTTP: (0, _cycleHttp.makeHTTPDriver)()
};

_cycleCore2['default'].run(main, drivers);

},{"@cycle/core":1,"@cycle/dom":2,"@cycle/http":10}]},{},[68]);
